...
function parse_inkbunny(data) {
	...
	for(var entry in items) {
		...
		this_image.score = score_inkbunny; // API doesn't provide a score, assume the default one
